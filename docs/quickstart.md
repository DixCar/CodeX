...
> Please, always use latest version of template or modules.
...
Use code below within AdobeCampaign to provide generic Plain Text for your Delivery Template

[filename](_includes/plain-text.md ':include')
